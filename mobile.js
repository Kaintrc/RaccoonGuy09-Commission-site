...
(function(){
  const isMobilePage = /mobile_index\.html$/i.test(window.location.pathname);
  const skipMobile = localStorage.getItem('skipMobile');

  if(!isMobilePage && mobileCheck() && !skipMobile){
